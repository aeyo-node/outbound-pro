...
CREATE TABLE IF NOT EXISTS agent_profiles (
    ...
    model TEXT NOT NULL DEFAULT 'gemini-2.5-flash-native-audio-preview-09-2025',
    system_prompt TEXT,
...
ALTER TABLE incoming_calls ADD COLUMN IF NOT EXISTS notes TEXT;
ALTER TABLE incoming_calls ADD COLUMN IF NOT EXISTS outcome TEXT;
